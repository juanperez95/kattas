...
<body>
    <nav class="navbar fixed-top" style="background-color: var(--color-fondo); height: 20%;">
        <div class="navega flex-colum flex-md-row">
          <a class="navbar-brand mr-auto" style="top: 0;" href="/index.php">
                    ...
                    <div>
                            ...
                            <!-- vista alerta -->
                                <div class="texto_login2">
                                    ...
                                    <form action="/Controladores/C_Registro.php" method="post" class="form">
                                    <div class="grupo1">
                                        <div class="etiqueta">
                                        ...
                                        <input type="number" id="contraseña" class="contraseña" name="cedula" required>
                                        </div>
                                        <div class="etiqueta">
                                        ...
                                        <input type="date" id="nacimiento" class="nacimiento" name="fechan" required>
                                        </div>
                                        <div class="etiqueta">
                                        ...
                                        <div class="etiqueta">
                                        <label for="barrio" class="barrio">Barrio</label>
                                        ...
                                        <input type="password" id="contraseña1" name="contraseña" placeholder="Mínimo 8 caracteres" minlength="8" required>
                                        </div>
                                        <div class="etiqueta">
                                        ...
                                        <button class="buton" type="submit" onclick="login()" style="font-size: 15px">Registrarse</button>

                                        <a href="#" class="pie">¿Olvidaste tu contraseña?</a>

                                        <a href="login.php" class="pie2">Iniciar sesión</a>
